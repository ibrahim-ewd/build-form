    ...
    <div class="d-flex align-items-center justify-content-between p-8">
        <div class="d-flex flex-column mr-2">
            ...
            <div class="d-flex align-items-center mt-2">
                ...
                <a href="#" class="btn   btn-light-success btn-icon mr-2"><i class="ki ki-minus icon-xs"></i></a>
                <a href="#" class="btn   btn-light-success btn-icon"><i class="ki ki-plus icon-xs"></i></a>
            </div>
        </div>
